...
from Romeo.modules.core.call import main, autoend
from Romeo.modules.database import (get_client, is_active_chat,
                                       is_autoend)
...
async def auto_leave():
    if config.AUTO_LEAVING_ASSISTANT == str(True):
        while not await asyncio.sleep(
            ...
            from mainMusic.core.userbot import assistants
