...
from Romeo.utilities.config import adminlist, chatstats, clean, userstats
from Romeo.utilities.strings import get_command
from Romeo import bot, app
from Romeo.misc import SUDOERS
from Romeo.modules.database import (get_active_chats,
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from Romeo.modules.core.app import assistants
