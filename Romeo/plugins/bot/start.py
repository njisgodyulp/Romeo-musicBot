...
from Romeo.utilities.config.config import OWNER_ID
from Romeo.utilities.strings import get_command, get_string
from Romeo import Telegram, YouTube, bot
...
from Romeo.modules.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from Romeo.modules.decorators.language import LanguageStart
from Romeo.utilities.inline import (help_pannel, private_panel, private_panelx, start_pannel)
...
⚡️ __Searched Powered By {config.MUSIC_BOT_NAME}__"""
        ...
        if await is_on_off(config.LOG):
            ...
            return await bot.send_photo(
                config.LOG_GROUP_ID,
                photo=f"https://telegra.ph/file/e745fdaf1966f228582dc.jpg",
                caption=f"""
**━━━━━━━━━━━━━━━━━━━**
