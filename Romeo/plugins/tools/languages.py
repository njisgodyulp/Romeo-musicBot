...
from Romeo.utilities.strings import get_command, get_string, languages_present
from Romeo import bot
from Romeo.modules.database import get_lang, set_lang
from Romeo.modules.decorators import (ActualAdminCB, language,
                                         languageCB)
