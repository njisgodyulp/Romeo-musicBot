...
from Romeo.utilities.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
...
from Romeo.modules.database import get_authuser_names, get_cmode
from Romeo.modules.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Romeo.modules.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await main.stop_stream(message.chat.id)
    except:
        pass
