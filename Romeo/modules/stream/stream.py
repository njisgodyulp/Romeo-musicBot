...
from Romeo import Carbon, YouTube, bot
from Romeo.modules.core.call import main
from Romeo.misc import db
from Romeo.modules.database import (add_active_chat,
                                             add_active_video_chat,
                                             is_active_chat,
                                             is_video_allowed, music_on)
from Romeo.modules.utils.exceptions import AssistantErr
from Romeo.utilities.inline.play import (stream_markup,
                                              telegram_markup)
from Romeo.utilities.inline.playlist import close_markup
from Romeo.modules.utils.pastebin import Mainbin
from Romeo.modules.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await main.force_stop_stream(chat_id)
