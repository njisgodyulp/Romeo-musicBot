...
from Romeo.utilities.config import MUSIC_BOT_NAME, YOUTUBE_IMG_URL
...
async def gen_thumb(videoid):
    ...
    try:
        ...
        image2 = Image.open(f"Romeo/resource/{images}.png")
        ...
        font = ImageFont.truetype("Romeo/resource/font.otf", 32)
        ...
        draw.text((190, 675), f"Romeo-RJ", (255, 255, 255), font=font)
        try:
